...
function footer() {
    return (
        <footer className="footer">
            <div className="">
                <div className="footer-brand-directory">
                    <div className="main-title">
                        <b>Top Stories: </b><span> Brand Directory </span>
                    </div>
                    <div className="fters">
                        <span className="title top-space">MOST SEARCHED FOR ON FLIPKART: </span>
                        <a href="/" className="no-hover"> Flipkart QuickTV &amp; Appliances Shop From Home DaysGrand Home Appliances SaleFlipkart Super Cooling DaysBig Screen TelevisionsTV &amp; Large Appliances Big Savings Day SaleAkshaya Tritiya OffersEd A Mamma ClothingBooksFlipkart Electronics: TV &amp; Home Appliances SaleFlipkart Cooling DaysAC Cooling Days 2021Refrigerator Cooling Days 2021Grand Kitchen &amp; Home Appliances SaleAuto Accessories StoreStreak SunglassesGold CoinsFlipkart PlusFlipkart Super CoinFlipkart COVID-19 InsuranceFlipkart Help CentreFlipkart Track OrdersFlipkart Manage OrdersFlipkart Return OrdersAuto Accessories StoreContact LensesFlipkart Gift Cards StoreSuper Fan ShowSareesFlipkart Axis Bank Credit CardFlipkart VideosFlipkart Pay LaterRedmi 8Honor 20iOPPO K1Flipkart Axis Bank Credit CardEarringsMens WatchesSilver CoinsJewelleryWatchesGold CoinMangalsutraSunglassesMi SunglassesBackpacksRay Ban Sunglasses MOBILES:iPhone 12 64GBiPhone 12 Pro 512GBiPhone 12 128GBVivo Y91iVivo Y11Vivo Y15Vivo Y50Vivo Y12Reno2 FOppo A12Oppo F15Oppo A31Samsung A71Samsung A51Samsung A31Realme X2Realme 5Infinix Hot 8iPhone 11iPhone 11 ProiPhone 11 Pro MaxMobile Offersiphone xiphone 8iphone 7iphone 6Redmi 5A4G MobileNokia MobileSamsung MobileiphoneOppo MobileVivo Mobile CAMERA:GoPro Action CameraNikon CameraCanon CameraSony CameraCanon DSLRNikon DSLR LAPTOPS:Microsoft Surface Go Pentium Gold 64GBMicrosoft Surface Go Pentium 128GBBranded LaptopsApple LaptopsAcer LaptopsLenovo LaptopsDell LaptopsAsus LaptopsHP LaptopsGaming Laptops2 in 1 LaptopsBusiness Laptops TVS:Motorola TVRedmi Smart TelevisionsOnePlus TVsRealme SLED 4K Smart TVsMI 43 Inch 4K TVMI 40 Inch TVMi 65 Inch  TVSamsung 32 Smart TVLG TVTVSony TVSamsung TVMi 49 Inch Smart TVAndroid TelevisionIffalcon TvMi TV LARGE APPLIANCES:Voltas ACHitachi ACLloyd ACBlue Star ACDaikin ACLG ACSamsung efrigeratorsHaier RefrigeratorWhirlpool RefrigeratorCLOTHING:Men ShirtsKurta PajamaMen T-ShirtsJeansCrop TopsRaincoatMen SuitsMen TrousersMens BlazersSareeDressesFloral DressesSkirtsKids DressesDesigner Salwar SuitsBraDesigner KurtisTrack PantMen KurtaGym WearParty DressesPalazzo SuitsBoys ClothingGlovesNightyMaxi DressesAnarkaliIndo Western DressGownsCulottesSherwaniGirls ClothesSalwar SuitsTopsLehengaDress MaterialsIndo western for menKurtisDesigner SareesSummer DressesLeggingsDesigner BlousesBlouse DesignsBanarasi SareesSilk SareesTissue SareesCotton SareesShortsBlouseLong SkirtsPalazzoWinter JacketsJoggersMini DressesNight SuitsBanarsi SuitInnerwearSports WearCapChanderi SareesLinen SareesPaithani SareesOff the shoulder topsPantiesGirls ShortsShrugsSalwarGirls DressesBikiniPajamasKids WearManyavar KurtasWomens TrousersJacketsWestern WearLevis JacketsSleepwearShawlsCardigansPulloverStolesDenim JacketsLeather JacketsClothingKids ClothingWinter WearScarvesSports JacketsGeorgette SareesEthnic WearBriefs &amp; TrunksSweatshirts FOOTWEAR:ShoesAdidas ShoesReebok ShoesNike ShoesPuma ShoesBootsBata ShoesWoodland ShoesSkechers ShoesSneakersWomens BootsSports ShoesLoafersSandalsLotto Sports ShoesCasual ShoesWomens Skechers ShoesAsics Sports ShoesFormal ShoesSchool Shoes GROCERIES:PhonePe Grocery VoucherHand WashSugar Jaggery SaltsRiceMasala &amp; SpicesDal PulsesAttaCookiesNoodlesGheeDry FruitsToor DalOlive OilSoapCashew NutsSunflower OilEggsToilet CleanerHarpic Toilet CleanerDettol SoapMustard OilBiscuitsCheesePatanjali AttaFortune OilAashirvaad AttaButterAmul MilkJuicesTata TeaGrocery StoreGrocery Essential StoreMuesliBreakfast CerealHand WashHand SanitizerLizol Floor CleanerDetergentsChipsTeaMilkChocolatesSoft DrinksRavaCoffeeSona Masoori RiceSugarColgate ToothpasteShampooAlmondsMoong DalInstant CoffeeParle Namkeen BEST SELLING ON FLIPKART:Samsung Galaxy Tab S7+BooksToy StoreCandlesHelmetsWall ClocksBaby FoodChocolatesCyclesCalculatorsLipsticksFastrack WatchesWalletsEarringsGold CoinsHandbags FURNITURE:Grand Furniture SaleFurnitureSofasBedsDining setsWardrobesMattressesTV UnitsTablesChairsShelvesBean BagsOffice ChairsComputer TableOffice TablesRed SofaWakefit BedsWhite SofaWakefit MattressGreen SofaBlack SofaBrown Sofa
                        </a>
                    </div>
                </div>
                <div className="footer-advantages">
                    ...
                    <div className="advantage">
                        <div className="advantage-title">EMI on Debit Cards</div>
                        <div className="advantage-desc">Did you know debit card holders account for 79.38 crore in the country, while there are only 3.14 crore credit card holders? After enabling EMI on Credit Cards, in another attempt to make online shopping accessible to everyone, Flipkart introduces EMI on Debit Cards, empowering you to shop confidently with us without having to worry about pauses in monthly cash flow. At present, we have partnered with Axis Bank, HDFC Bank, State Bank of India and ICICI Bank for this facility. More power to all our shoppers! Terms and conditions apply.</div>
                    </div>
                    <div className="advantage">
                        <div className="advantage-title">
                    ...
                    <div className="advantage">
                        <div className="advantage-title">What Can You Buy From Flipkart?</div>
                        <div className="advantage-title">Mobile Phones</div>
                        <div className="advantage-desc">
                        ...
                        <div className="advantage-title">Electronic Devices and Accessories</div>
                        <div className="advantage-desc">
                        ...
                        <div className="advantage-title">Large Appliances</div>
                        <div className="advantage-desc">
            ...
            <div className="footer-dark">
                <div className="main-footer">
                    <div className="spec-links border-bottom">
                        <div className="row">
                            <div className="col">
                            ...
                            <div className="col border-left text-only">
                                <div className="title">Mail Us:</div>
                                <div className="add-atributes-secondery">
                                    <a href="/" className="no-hover">Flipkart Internet Private Limited, </a>
                                    <a href="/" className="no-hover"> Buildings Alyssa, Begonia &amp; </a>
                                    <a href="/" className="no-hover"> Clove Embassy Tech Village, </a>
                                    <a href="/" className="no-hover"> Outer Ring Road, Devarabeesanahalli Village, </a>
                                    <a href="/" className="no-hover"> Bengaluru, 560103, </a>
                                    <a href="/" className="no-hover"> Karnataka, India</a>
                                </div>
                            </div>
                            <div className="col">
                                ...
                                <div className="add-atributes-secondery">
                                    ...
                                    <a href="/" className="no-hover">Bengaluru, 560103,</a>
                                    <a href="/" className="no-hover">Karnataka, India</a>
                                    <a href="/" className="no-hover">CIN : U51109KA2012PTC066107</a>
                                    <a href="/" className="no-hover">Telephone: <span className="link">1800 202 9898</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="copyright-foot d-flex">
                        <div>
                            ...
                            <a href="https://seller.flipkart.com/?utm_source=fkwebsite&amp;utm_medium=websitedirect" className="text-light no-hover">Sell On Flipkart</a>
                        </div>
                        <div>
                            ...
                            <a href="https://brands.flipkart.com" className="no-hover text-light">Advertise</a>
                        </div>
                        <div>
                            ...
                            <a href="/the-gift-card-store?otracker=undefined_footer_footer_navlinks" className="no-hover text-light">Gift Cards</a>
                        </div>
                        <div>
                            ...
                            <a href="/helpcentre?otracker=undefined_footer_footer_navlinks" className="text-light no-hover">Help Center</a>
                        </div>
                        <div>
                            &copy; 2007-2021 Flipkart.com
                        </div>
                        <div>
                            <img src="https://static-assets-web.flixcart.com/www/linchpin/fk-cp-zion/img/payment-method_69e7ec.svg" alt="img" />
                        </div>
                    </div>
                </div>
